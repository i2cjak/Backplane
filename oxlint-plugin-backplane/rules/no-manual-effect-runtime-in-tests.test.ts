...
const rule = createOxlintRuleHarness("backplane/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("backplane/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("backplane/no-manual-effect-runtime-in-tests");
...
const legacyRule = createOxlintRuleHarness("backplane/no-manual-effect-runtime-in-tests", {
  filename: "legacy.test.ts",
  ruleOptions: [{ maxOccurrences: 2 }],
});

describe("backplane/no-manual-effect-runtime-in-tests with maxOccurrences", () => {
  legacyRule.valid(
