...
const rule = createOxlintRuleHarness("backplane/no-native-title-tooltip", {
  filename: "fixture.tsx",
});

describe("backplane/no-native-title-tooltip", () => {
  rule.valid(
  ...
  rule.valid("allows document.title assignments", `document.title = "Thread · Backplane";`);
