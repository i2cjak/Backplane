    ...
    const provider = yield* makeProvider({
      getPullRequest: () =>
        Effect.succeed({
          ...
          headRepositoryNameWithOwner: "fork/backplane",
...
it.effect("adds safe request context while retaining GitHub CLI causes", () =>
  Effect.gen(function* () {
    ...
    const error = yield* provider
      .getChangeRequest({
        cwd: "/repo",
        reference: "https://user:secret@github.com/i2cjak/backplane/pull/42?token=secret#diff",
      })
      .pipe(Effect.flip);
    ...
    assert.deepStrictEqual(
      ...
      },
      {
        ...
        command: "gh",
        cwd: "/repo",
        reference: "https://github.com/i2cjak/backplane/pull/42",
            ...
            JSON.stringify([
              {
                number: 7,
                title: "Merged work",
                url: "https://github.com/i2cjak/backplane/pull/7",
                baseRefName: "main",
