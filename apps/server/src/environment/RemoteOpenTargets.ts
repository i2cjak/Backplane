 ...
 */
import { type RemoteOpenTarget } from "@backplane/contracts";
import { HostProcessHostname } from "@backplane/shared/hostProcess";
import * as NetService from "@backplane/shared/Net";
import { readTailscaleStatus } from "@backplane/tailscale";
...
>()("@backplane/cli/environment/RemoteOpenTargets") {}
