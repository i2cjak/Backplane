...
// per-command cache lookups in @backplane/shared/shell.
//
...
// command-resolution cache in @backplane/shared/shell, so a backward wall-clock
...
>()("@backplane/cli/process/externalLauncher") {}
