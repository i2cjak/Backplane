  ...
  it.effect("carries every repository and every qualifier into one search", () =>
    Effect.gen(function* () {
      ...
      yield* cli.searchPullRequests({
        cwd: "/w",
        host: "github.com",
        repositories: ["acme/web", "i2cjak/backplane"],
        state: "closed",
        involvement: "reviewing",
        viewer: "bilal",
        limit: 10,
      ...
      assert.strictEqual(
        ...
        'is:pr is:closed is:unmerged review-requested:bilal "pull requests page" ' +
          "updated:<=2026-07-02T00:00:00Z sort:updated-desc repo:acme/web repo:i2cjak/backplane",
      );
    }),
  );
    ...
    Effect.gen(function* () {
      mockedExecute.mockReturnValue(
        Effect.succeed(
          searchPage([
            ...
            searchItem(9, "i2cjak/backplane", "2026-07-02T00:00:00Z"),
      ...
      assert.deepStrictEqual(
        ...
        [
          ...
          ["i2cjak/backplane", 9, "https://avatars/octocat"],
        ],
      );
