...
export function buildResourceTelemetryHistory(
  ...
  for (const snapshot of snapshots) {
    ...
    aggregateSamples.push({
      ...
      cpuPercent: merged.groups.allBackplane.currentCpuPercent,
      rssBytes: merged.groups.allBackplane.currentRssBytes,
      processCount: merged.groups.allBackplane.processCount,
