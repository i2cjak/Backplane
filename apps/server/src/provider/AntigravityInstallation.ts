...
import { ProviderDriverKind, type ProviderInstallState } from "@backplane/contracts";
import {
...
>()("@backplane/cli/provider/AntigravityInstallation") {
    ...
    Effect.fn("AntigravityInstallation.validate")(
      function* (executable: AntigravityExecutable, expectedVersion: string) {
        const profileDirectory = yield* fs.makeTempDirectoryScoped({
          prefix: "backplane-antigravity-validate-",
        });
