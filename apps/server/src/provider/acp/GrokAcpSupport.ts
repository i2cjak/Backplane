import { type GrokSettings, ProviderDriverKind, type RuntimeMode } from "@backplane/contracts";
...
import { normalizeModelSlug } from "@backplane/shared/model";
...
const BACKPLANE_CODE_OAUTH_REFERRER = "backplane";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: BACKPLANE_CODE_OAUTH_REFERRER,
    },
  };
}
...
/**
 * Backplane's built-in Grok slug. It is the CLI's product name, not a model id the ACP accepts,
