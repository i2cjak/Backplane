...
import { type ProviderApprovalDecision, type ProviderEvent, ThreadId } from "@backplane/contracts";
  ...
  it.effect("looks up child model metadata once after activity registration", () =>
    Effect.gen(function* () {
      ...
      const runtime = yield* makeCodexSessionRuntime({
        ...
        environment: { ...process.env, BACKPLANE_CODEX_COLLAB_SCRIPT: scriptPath },
      });
