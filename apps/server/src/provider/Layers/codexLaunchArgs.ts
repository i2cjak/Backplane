import { tokenizeCliArgs } from "@backplane/shared/cliArgs";

export const BACKPLANE_CODEX_LAUNCH_ARGS_ENV = "BACKPLANE_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[BACKPLANE_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
