          ...
          ...(mcpSession
            ? {
                environment: {
                  ...
                  BACKPLANE_MCP_BEARER_TOKEN: mcpSession.authorizationHeader.replace(
                    /^Bearer\s+/,
                    "",
                  ),
                },
                appServerArgs: [
                  "-c",
                  `mcp_servers.backplane.url=${mcpSession.endpoint}`,
                  "-c",
                  'mcp_servers.backplane.bearer_token_env_var="BACKPLANE_MCP_BEARER_TOKEN"',
                ],
              }
            : {}),
        };
