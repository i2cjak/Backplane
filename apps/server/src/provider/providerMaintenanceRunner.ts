...
>()("@backplane/cli/provider/providerMaintenanceRunner") {}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Backplane could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Backplane still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
