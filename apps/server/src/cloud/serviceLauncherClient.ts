import type { ServerSelfUpdateOutcome } from "@backplane/contracts";
  ...
  override get message(): string {
    switch (this.operation) {
      ...
      case "version-mismatch":
        return "The service launcher started a different backplane version.";
...
export const ServiceLauncherHostProcess = Context.Reference<ServiceLauncherProcess>(
  "@backplane/cli/cloud/serviceLauncherHostProcess",
  {
    defaultValue: () => ({
...
>()("@backplane/cli/cloud/serviceLauncherClient") {}
