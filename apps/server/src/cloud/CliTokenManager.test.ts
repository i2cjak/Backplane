import { readConnectAuthorizeRequest } from "@backplane/shared/connectAuth";
...
const TEST_ENV = {
  BACKPLANE_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  BACKPLANE_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  BACKPLANE_HOSTED_APP_URL: "https://hosted.example.test",
};
