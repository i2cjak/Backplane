...
import { type CursorSettings, type ModelSelection } from "@backplane/contracts";
import { sanitizeBranchFragment, sanitizeFeatureBranchName } from "@backplane/shared/git";
import { extractJsonObject } from "@backplane/shared/schemaJson";
  ...
  const runCursorJson = <S extends Schema.Top>({
    ...
    Effect.gen(function* () {
      ...
      const runtime = yield* makeCursorAcpRuntime({
        ...
        cwd,
        clientInfo: { name: "backplane-git-text", version: "0.0.0" },
