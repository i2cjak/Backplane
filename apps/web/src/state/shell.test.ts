...
import type { EnvironmentCatalogState } from "@backplane/client-runtime/state/connections";
import type { EnvironmentShellState } from "@backplane/client-runtime/state/shell";
