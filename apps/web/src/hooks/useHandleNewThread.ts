...
import { resolveDefaultThreadEnvMode } from "@backplane/shared/threadEnvMode";
...
import { readBackplaneProjectFileDefaultThreadEnvMode } from "../lib/backplaneProjectFileDefaults";
...
export function useNewThreadHandler() {
  ...
  return useCallback(
    (
      ...
      // The shared resolver owns the priority order. The backplane.json read is
      ...
      const resolveDefaultEnvMode = async (): Promise<DraftThreadEnvMode> => {
        ...
        return resolveDefaultThreadEnvMode({
          ...
          projectFile: consultProjectFile
            ? await readBackplaneProjectFileDefaultThreadEnvMode(
