...
import type { AssistantCitation, MessageId, ScopedThreadRef } from "@backplane/contracts";
...
const COMMENT_HIGHLIGHT_NAME = "backplane-assistant-citation-comment";
...
export function observeAssistantCitationSource({
  ...
  const clear = () => {
    if (highlighted && CSS.highlights.get("backplane-assistant-citation") === highlighted) {
      CSS.highlights.delete("backplane-assistant-citation");
    }
    highlighted = null;
    ownedRange = null;
  ...
  const highlight = () => {
    ...
    if (typeof Highlight !== "undefined" && typeof CSS !== "undefined" && CSS.highlights) {
      ...
      CSS.highlights.set("backplane-assistant-citation", highlighted);
      ownedRange = range;
    ...
    if (!pulseAnimation) {
      ...
      pulseAnimation.id = "backplane-assistant-citation-pulse";
