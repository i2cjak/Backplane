...
const FILE_EXPLORER_STORAGE_KEY = "backplane.fileExplorerOpen";
const RENDER_MARKDOWN_STORAGE_KEY = "backplane.renderMarkdown";
const RENDER_BROWSER_FILE_STORAGE_KEY = "backplane.renderBrowserFile";
