...
const NO_FILE_SCRIPTS: ReadonlyArray<BackplaneProjectFileScript> = [];

interface ProjectScriptsControlProps {
  scripts: ReadonlyArray<ProjectScript>;
  /** Scripts declared in the project's checked-in backplane.json, offered for import. */
  fileScripts?: ReadonlyArray<BackplaneProjectFileScript>;
...
export default function ProjectScriptsControl({
  ...
  const importFileScript = async (fileScript: BackplaneProjectFileScript) => {
  ...
  const importMenuItems = importableScripts.length > 0 && (
    <>
      ...
      <MenuGroup>
        <MenuGroupLabel>From backplane.json</MenuGroupLabel>
