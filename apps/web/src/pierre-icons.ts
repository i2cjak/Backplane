...
import { VIDEO_FILE_EXTENSIONS } from "@backplane/shared/video";
...
const PIERRE_ICON_SPRITE_ID = "backplane-pierre-file-icon-sprite";

const BACKPLANE_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <!-- Lucide Film icon, ISC license. -->
  <symbol id="backplane-file-icon-video" viewBox="0 0 24 24">
  ...
  <symbol id="backplane-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="backplane-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="backplane-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="backplane-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="backplane-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="backplane-file-icon-pnpm" viewBox="0 0 32 32">
...
export const BACKPLANE_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: BACKPLANE_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "backplane-file-icon-package-json",
    "tsconfig.json": "backplane-file-icon-tsconfig",
    "agents.md": "backplane-file-icon-agents",
    "claude.md": "backplane-file-icon-claude",
    "readme.md": "backplane-file-icon-readme",
    "pnpm-lock.yaml": "backplane-file-icon-pnpm",
    "pnpm-workspace.yaml": "backplane-file-icon-pnpm",
  },
  byFileExtension: Object.fromEntries(
    VIDEO_FILE_EXTENSIONS.map((extension) => [extension, "backplane-file-icon-video"]),
  ),
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(BACKPLANE_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${BACKPLANE_FILE_ICON_SPRITE}`;
