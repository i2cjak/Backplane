...
import type { EnvironmentCloudLinkStateResult } from "@backplane/contracts";
...
export function usePrimaryCloudLinkState() {
  ...
  if (result._tag === "Failure") {
    ...
    error = cause instanceof Error ? cause.message : "Could not read Backplane Connect link state.";
  }
