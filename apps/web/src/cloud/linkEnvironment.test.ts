...
import { RelayWebClientId } from "@backplane/contracts/relay";
...
import { type RpcSession } from "@backplane/client-runtime/rpc";
import { EnvironmentRegistry } from "@backplane/client-runtime/connection";
import { ManagedRelay } from "@backplane/client-runtime/relay";
...
beforeEach(() => {
  vi.clearAllMocks();
  vi.stubEnv("VITE_BACKPLANE_RELAY_URL", "https://relay.example.test");
