...
export const PERSISTED_STATE_KEY = "backplane:ui-state:v1";
// Version 1 stored card visibility, not folder expansion.
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 2;
const LEGACY_PERSISTED_STATE_KEYS = [
  "backplane:renderer-state:v8",
  "backplane:renderer-state:v7",
  "backplane:renderer-state:v6",
  "backplane:renderer-state:v5",
  "backplane:renderer-state:v4",
  "backplane:renderer-state:v3",
