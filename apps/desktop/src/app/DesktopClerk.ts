...
>()("@backplane/desktop/app/DesktopClerk") {}
...
export const make = Effect.gen(function* () {
  ...
  // the lock would create "Backplane" and make the legacy-install
  // resolution uses the same isolated path before acquiring the instance lock.
