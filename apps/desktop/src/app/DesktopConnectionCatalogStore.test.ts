...
import { ConnectionCatalogDocument } from "@backplane/client-runtime/platform";
import { EnvironmentId, type PersistedSavedEnvironmentRecord } from "@backplane/contracts";
...
const withStore = <A, E, R>(
  ...
  Effect.gen(function* () {
    ...
    const baseDir = yield* fileSystem.makeTempDirectoryScoped({
      prefix: "backplane-desktop-connection-catalog-test-",
    });
