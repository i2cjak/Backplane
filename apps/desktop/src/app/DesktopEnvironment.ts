...
export class DesktopEnvironment extends Context.Service<
  DesktopEnvironment,
  {
    ...
    readonly devRemoteBackplaneServerEntryPath: Option.Option<string>;
...
>()("@backplane/desktop/app/DesktopEnvironment") {}

const APP_BASE_NAME = "Backplane";
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  return DesktopEnvironment.of({
    ...
    devServerUrl,
    devRemoteBackplaneServerEntryPath: config.devRemoteBackplaneServerEntryPath,
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "works.backplane.app.dev" : "works.backplane.app",
    ),
    linuxDesktopEntryName: isDevelopment ? "backplane-dev.desktop" : "backplane.desktop",
    linuxWmClass: isDevelopment ? "backplane-dev" : "backplane",
