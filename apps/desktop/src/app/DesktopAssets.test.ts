...
describe("DesktopAssets", () => {
  it.effect("uses canonical source-tree icons for unpackaged development", () =>
    Effect.gen(function* () {
      ...
      assert.match(Option.getOrThrow(icons.ico), /assets\/dev\/backplane-windows\.ico$/);
      assert.match(Option.getOrThrow(icons.png), /assets\/dev\/backplane-universal-1024\.png$/);
