...
>()("@backplane/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__BACKPLANE_ENV_${name}_START__`;
const endMarker = (name: string) => `__BACKPLANE_ENV_${name}_END__`;
