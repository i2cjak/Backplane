...
const PREVIEW_PARTITION_PREFIX = "persist:backplane-preview-";
/**
 ...
 */
const PREVIEW_EPHEMERAL_PARTITION_PREFIX = "backplane-preview-ephemeral-";
...
>()("@backplane/desktop/preview/BrowserSession") {}
