 ...
 * into a Backplane browser profile's Electron partition.
 *
...
import { BrowserImportFailureReason } from "@backplane/contracts";
...
>()("@backplane/desktop/preview/BrowserImport/BrowserImport") {}
