import type { DesktopSshPasswordPromptRequest } from "@backplane/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@backplane/contracts";
import type { SshPasswordRequest } from "@backplane/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedErrorClass<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `Backplane window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@backplane/desktop/ssh/DesktopSshPasswordPrompts") {}
