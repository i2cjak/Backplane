...
import { waitForHttpReady as waitForHttpReadyShared } from "@backplane/shared/httpReadiness";
...
const BACKEND_READINESS_PATH = "/.well-known/backplane/environment";
...
export interface DesktopBackendStartConfig extends BackendProcessContext {
  ...
  // BACKPLANE_HOME can't pin the WSL backend to /mnt/c/...\.backplane.
