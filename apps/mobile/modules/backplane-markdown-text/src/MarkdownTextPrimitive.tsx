...
import BackplaneMarkdownTextRunNativeComponent from "./BackplaneMarkdownTextRunNativeComponent";
import BackplaneMarkdownTextNativeComponent from "./BackplaneMarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <BackplaneMarkdownTextRunNativeComponent
  ...
  if (!isAncestor) {
    ...
    return (
      <TextAncestorContext.Provider value={contextValue}>
        <BackplaneMarkdownTextNativeComponent
          {...textDefaults}
          {...containerProps}
          style={[flattenedStyle]}
        >
