...
import { installMarkdownCopySanitizer } from "./BackplaneMarkdownTextSelectionModule";
...
export function NativeMarkdownSelectableText(props: {
  ...
  // BackplaneMarkdownText only rebuilds its attributed string during native layout. A
        ...
        return (
          <MarkdownTextPrimitive
            ...
            nativeID={
              Platform.OS === "ios"
                ? run.fileIcon
                  ? `backplane-file:${Image.resolveAssetSource(markdownFileIconSource(run.fileIcon)).uri}`
                  : run.skillName
                    ? "backplane-skill:sf:cube"
                    : linkIcon
                      ? `backplane-link:${Image.resolveAssetSource(markdownLinkIconSource(linkIcon)).uri}`
                      : undefined
                : undefined
            }
