...
private final class ComposerTextView: UITextView {
  private static let pastedImageDirectoryName = "backplane-composer-paste"
...
public final class BackplaneComposerEditorView: ExpoView, UITextViewDelegate, UITextDropDelegate {
