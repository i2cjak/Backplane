...
const CONNECTIONS_KEY = "backplane.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "backplane.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "backplane.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "backplane.recent-thread-shortcuts";
...
>()("@backplane/mobile/persistence/MobileStorage") {}
