...
import type { SidebarProjectGroupingMode } from "@backplane/contracts";
...
const PREFERENCES_KEY = "backplane.preferences";
const PREFERENCES_FALLBACK_KEY = "backplane.preferences.fallback";
...
>()("@backplane/mobile/persistence/MobilePreferencesStore") {}
