...
export function ControlPill(props: {
  ...
  const containerClassName = cn(
    isCircle
      ? "h-11 w-11 items-center justify-center rounded-none"
      : variant === "primary"
        ? "h-11 flex-row items-center justify-center gap-2 rounded-none px-5"
        : "h-11 flex-row items-center justify-center gap-2 rounded-none px-3.5",
    variant === "primary"
      ? props.disabled
        ? "bg-subtle-strong"
        : "bg-primary"
  ...
  const labelClassName = cn(
    "text-center text-xs font-backplane-bold",
    variant === "primary"
      ? props.disabled
