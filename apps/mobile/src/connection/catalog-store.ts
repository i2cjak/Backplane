...
import { ConnectionTransientError } from "@backplane/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "backplane.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "backplane.connections";
