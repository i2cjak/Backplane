...
describe("resolveMarkdownMediaPreview", () => {
  ...
  it("serves a linked Backplane attachment file in place like any other host path", () => {
    const path =
      "/home/demo/.backplane/userdata/attachments/11111111-1111-4111-8111-111111111111-mp4.mp4";
