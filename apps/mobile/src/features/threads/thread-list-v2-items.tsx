...
import { canSnooze, resolveSnoozePresets } from "@backplane/client-runtime/state/thread-settled";
...
export const ThreadListV2SectionDivider = memo(function ThreadListV2SectionDivider(props: {
  ...
  return (
    ...
    >
      <Text className="text-xs font-backplane-medium text-foreground-tertiary">{props.label}</Text>
...
export const ThreadListV2SnoozedShelfHeader = memo(function ThreadListV2SnoozedShelfHeader(props: {
  ...
  return (
    ...
    >
      <Text className="text-xs font-backplane-medium text-foreground-secondary">
...
export const ThreadListV2SettledShelfHeader = memo(function ThreadListV2SettledShelfHeader(props: {
  ...
  return (
    <Pressable
      ...
      style={({ pressed }) => ({ opacity: pressed ? 0.6 : 1 })}
    >
      <Text className="text-xs font-backplane-medium text-foreground-tertiary">
  ...
  const rowContent = (
    <>
      <View className="flex-row items-center gap-1.5">
        ...
        <Text
          className="flex-1 text-sm font-backplane-medium text-foreground-muted"
          numberOfLines={1}
        >
          {projectTitle}
        </Text>
      ...
      <Text className="mt-1 text-base font-backplane-medium text-foreground" numberOfLines={1}>
        {pendingTask.title}
      </Text>
  ...
  const cardContent = (
    <>
      <View className="flex-row items-center gap-1.5">
        ...
        <Text
          className={cn(
            "flex-1 text-sm font-backplane-medium",
      ...
      <Text
        className={cn(
          "mt-1 text-base font-backplane-medium",
