...
import { type EnvironmentMachineKind, resolveEnvironmentMachineKind } from "@backplane/contracts";
...
function CacheEnvironmentRow(props: {
  ...
  return (
    ...
    >
      ...
      >
        <Text
          className="font-backplane-medium tabular-nums text-danger-foreground"
          numberOfLines={1}
        >
