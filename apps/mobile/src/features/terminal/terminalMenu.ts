import { type KnownTerminalSession } from "@backplane/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@backplane/contracts";
import { nextTerminalId, resolveTerminalSessionLabel } from "@backplane/shared/terminalLabels";
