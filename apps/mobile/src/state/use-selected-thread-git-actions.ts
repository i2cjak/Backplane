...
import { EnvironmentProject, EnvironmentThreadShell } from "@backplane/client-runtime/state/shell";
import type { AtomCommandResult } from "@backplane/client-runtime/state/runtime";
import {
  type GitActionRequestInput,
  type VcsActionOperation,
  type VcsRef,
} from "@backplane/client-runtime/state/vcs";
import type { GitRunStackedActionResult } from "@backplane/contracts";
import {
