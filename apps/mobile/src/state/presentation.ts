...
import type { EnvironmentPresentation } from "@backplane/client-runtime/connection";
import { createEnvironmentPresentationAtoms } from "@backplane/client-runtime/state/presentation";
