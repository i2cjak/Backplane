  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Backplane prerelease is available for nightly testers."
          : "A new Backplane latest release is available.",
...
).pipe(Command.withDescription("Post a Backplane release announcement to Discord."));
