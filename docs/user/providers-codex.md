...
Both instances must use the same **CODEX_HOME path**. Backplane prepares the shared
...
Choose the other account from the thread's model picker. Backplane offers compatible
