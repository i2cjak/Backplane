...
The Backplane server sends product usage events to PostHog, associated with a hashed account or
...
To disable collection, set `BACKPLANE_TELEMETRY_ENABLED=false` in the server's environment before
