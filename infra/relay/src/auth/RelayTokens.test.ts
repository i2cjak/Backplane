...
import { signRelayJwt } from "@backplane/shared/relayJwt";
  ...
  it.effect("rejects signed DPoP tokens whose scope is outside the relay policy", () =>
    Effect.gen(function* () {
      ...
      const token = yield* signRelayJwt({
        ...
        typ: "backplane-relay-dpop-access+jwt",
        payload: {
