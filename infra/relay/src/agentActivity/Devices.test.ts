import type { RelayDeviceRegistrationRequest } from "@backplane/contracts/relay";
...
const registration: RelayDeviceRegistrationRequest = {
  ...
  bundleId: "works.backplane.app.preview" as RelayDeviceRegistrationRequest["bundleId"],
    ...
    return Effect.gen(function* () {
      ...
      expect(insertedValues).toEqual([
        expect.objectContaining({
          userId: "user-2",
          deviceId: "device-1",
          bundleId: "works.backplane.app.preview",
          apsEnvironment: "production",
