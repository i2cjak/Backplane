...
> = {
  ...
  bitbucket: {
    missing:
      "Bitbucket needs API credentials on the server. Set BACKPLANE_BITBUCKET_EMAIL and BACKPLANE_BITBUCKET_API_TOKEN, or BACKPLANE_BITBUCKET_ACCESS_TOKEN.",
    unauthenticated:
      "Bitbucket rejected the configured credentials. Check BACKPLANE_BITBUCKET_EMAIL and BACKPLANE_BITBUCKET_API_TOKEN.",
  },
};
