 ...
 * machine into a Backplane browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** Backplane profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give Backplane Full Disk Access in System Settings → Privacy & Security, then retry.",
