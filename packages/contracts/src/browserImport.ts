 ...
 * machine into a T3CAD browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** T3CAD profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give T3CAD Full Disk Access in System Settings → Privacy & Security, then retry.",
