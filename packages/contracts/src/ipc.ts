...
export interface DesktopPreviewWebviewConfig {
  /** `persist:backplane-preview` (or whatever the desktop chose). */
  partition: string;
  /**
...
export interface DesktopBridge {
  ...
  /** Present when the desktop shell accepts `backplane app` activation requests. */
  appActivation?: {
...
export const DESKTOP_PREVIEW_RECORDING_CAPTURE_TRIGGER =
  "__backplaneDesktopPreviewRecordingCapture";
