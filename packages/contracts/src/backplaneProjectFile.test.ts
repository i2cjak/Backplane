...
import { BackplaneProjectFile } from "./backplaneProjectFile.ts";

const decode = Schema.decodeUnknownSync(BackplaneProjectFile);

describe("BackplaneProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://backplane.works/schema/backplane.json",
