export const BUILT_IN_THEME_IDS = ["backplane-chat", "grove", "ocean", "ember", "iris"] as const;

/** The mobile app's own hand-tuned palette, which is not part of the built-in library. */
export const MOBILE_DEFAULT_THEME_ID = "backplane";
...
export const BACKPLANE_CHAT_THEME: ThemeDefinition = {
  id: "backplane-chat",
  label: "Backplane Chat",
  appearance: "light",
  colors: {
