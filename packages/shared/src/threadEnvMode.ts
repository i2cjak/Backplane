import type { ThreadEnvMode } from "@backplane/contracts";

/**
 * Canonical priority order for a project's default thread env mode:
 * per-project setting > checked-in backplane.json > global server setting.
 *
 ...
 * source that outranks backplane.json decided, or the file read settled. While
