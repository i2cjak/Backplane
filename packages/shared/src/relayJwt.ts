...
export const RELAY_LINK_PROOF_TYP = "backplane-env-link+jwt";
export const RELAY_MINT_REQUEST_TYP = "backplane-cloud-mint+jwt";
export const RELAY_HEALTH_REQUEST_TYP = "backplane-cloud-health+jwt";
export const RELAY_MINT_RESPONSE_TYP = "backplane-env-mint+jwt";
export const RELAY_HEALTH_RESPONSE_TYP = "backplane-env-health+jwt";
export const RELAY_ACTIVITY_PUBLISH_TYP = "backplane-env-activity+jwt";
