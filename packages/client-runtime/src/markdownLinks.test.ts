...
describe("parseFileUrlHref", () => {
  it.each([
    ...
    [
      "file:///D:/Programme/backplane/OpenInPicker.tsx#L69",
      "D:/Programme/backplane/OpenInPicker.tsx",
      "#L69",
    ],
...
describe("parseMarkdownFileLink", () => {
  ...
  it.each([
    ...
    ["\\\\server\\share\\image.png", "\\\\server\\share\\image.png"],
    ["/D:/Programme/backplane/OpenInPicker.tsx", "D:/Programme/backplane/OpenInPicker.tsx"],
    ["</D:/Programme/backplane/ChatMarkdown.tsx:1>", "D:/Programme/backplane/ChatMarkdown.tsx"],
...
describe("workspaceRelativeFilePath", () => {
  it.each([
    ...
    ["/repo/project/src/main.ts", "/repo/project/", "src/main.ts"],
    ["C:\\Users\\mike\\backplane\\apps\\web\\a.ts", "C:/Users/mike/backplane", "apps/web/a.ts"],
    ["/C:/Users/mike/backplane/apps/web/a.ts", "C:/Users/mike/backplane", "apps/web/a.ts"],
    ...
    ["C:/USERS/mike/backplane/main.ts", "c:/users/MIKE/backplane", "main.ts"],
    ["/C:/USERS/mike/backplane/main.ts", "/c:/users/MIKE/backplane", "main.ts"],
