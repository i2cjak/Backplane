import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@backplane/contracts";
...
}>("@backplane/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
}>("@backplane/client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
