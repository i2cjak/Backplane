...
>()("@backplane/client-runtime/platform/persistence/ConnectionTargetStore") {}
...
>()("@backplane/client-runtime/platform/persistence/ConnectionRegistrationStore") {}
...
>()("@backplane/client-runtime/platform/persistence/EnvironmentCacheStore") {}
...
}>("@backplane/client-runtime/platform/persistence/EnvironmentOwnedDataCleanup", {
  defaultValue: () => ({
    clear: () => Effect.void,
  }),
}) {}
