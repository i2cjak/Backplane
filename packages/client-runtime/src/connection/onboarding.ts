import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@backplane/contracts";
import { resolveRemotePairingTarget } from "@backplane/shared/remote";
...
>()("@backplane/client-runtime/connection/onboarding/ConnectionOnboarding") {}
