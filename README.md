...
Download an installer for your system from [Backplane Releases](https://github.com/i2cjak/Backplane/releases). Each release lists its supported platforms. Installers include the desktop app, server, and the matching Backplane KiCad runtime.
